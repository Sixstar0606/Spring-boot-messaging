...
public class AuthController {
	...
	@PostMapping("/signup")
		public String processRegister(@Valid @RequestBody SignupRequest SignupRequest, HttpServletRequest request)
				throws UnsupportedEncodingException, MessagingException {

			User user = new User("Migl", "prodev08@gmail.com" , "Six.star66");
			// User user("Miguel", "prodev0128@gmail.com", "Six.star66");
			user.setUsername(SignupRequest.getUsername());
			user.setEmail(SignupRequest.getEmail());
			user.setPassword(SignupRequest.getPassword());
			user.setVerificationCode("1233456");
